%Синтез и анализ алгоритмов распознавания ГСВ с одинаковой 
...
for i=1:M,%цикл по классам    
    ims = repmat(m(:,i), [1, NN(i)]) + randncor(n,NN(i),C); %генерация К образов i-го класса
    if (n == 2)            
